...
export const Dock: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className={`DOCK-BACKGROUND h-16  rounded-2xl bg-[#f6f6f636] backdrop-blur-[135px] transition-transform duration-500  flex justify-center items-center overflow-hidden box-content px-1.5  pt-1.5 ${
